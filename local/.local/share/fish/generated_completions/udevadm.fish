...
complete -c udevadm -s l -l log-priority --description 'Set the internal log level of udevd.'
complete -c udevadm -l stop-exec-queue --description 'Signal udevd to stop executing new events.  Incoming events will be queued.'
complete -c udevadm -l start-exec-queue --description 'Signal udevd to enable the execution of events.'
complete -c udevadm -s R -l reload --description 'Signal udevd to reload the rules files and other databases like the kernel mo…'
complete -c udevadm -l property --description 'Set a global property for all events.'
complete -c udevadm -s m -l children-max --description 'Set the maximum number of events, udevd will handle at the same time.'
...
complete -c udevadm -l update --description 'Compile the hardware database information located in /usr/lib/udev/hwdb.'
