# dhcpcd
# Autogenerated from man page /usr/share/man/man8/dhcpcd.8
complete -c dhcpcd -s b --description 'Background immediately.'
complete -c dhcpcd -s c --description 'Use this script instead of the default /usr/libexec/dhcpcd-run-hooks.'
...
complete -c dhcpcd -s o --description 'Request the DHCP option variable for use in /usr/libexec/dhcpcd-run-hooks.'
...
complete -c dhcpcd -s T --description 'On receipt of DHCP messages just call /usr/libexec/dhcpcd-run-hooks with the …'
